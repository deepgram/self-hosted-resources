...
![Version: 0.14.0](https://img.shields.io/badge/Version-0.14.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: release-250626](https://img.shields.io/badge/AppVersion-release--250626-informational?style=flat-square) [![Artifact Hub](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/deepgram-self-hosted)](https://artifacthub.io/packages/search?repo=deepgram-self-hosted)n
...
| api.image.tag | string | `"release-250626"` | tag defines which Deepgram release to use for API containers |
...
| engine.image.tag | string | `"release-250626"` | tag defines which Deepgram release to use for Engine containers |
...
| licenseProxy.image.tag | string | `"release-250626"` | tag defines which Deepgram release to use for License Proxy containers |
